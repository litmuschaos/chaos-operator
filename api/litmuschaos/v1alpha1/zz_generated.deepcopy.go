...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailureOutput) DeepCopyInto(out *FailureOutput) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailureOutput.
func (in *FailureOutput) DeepCopy() *FailureOutput {
	if in == nil {
		return nil
	}
	out := new(FailureOutput)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TestStatus) DeepCopyInto(out *TestStatus) {
	*out = *in
	if in.FailureOutput != nil {
		in, out := &in.FailureOutput, &out.FailureOutput
		*out = new(FailureOutput)
		**out = **in
	}
}
