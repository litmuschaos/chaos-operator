...
func (c *FakeChaosEngines) Create(ctx context.Context, chaosEngine *v1alpha1.ChaosEngine) (result *v1alpha1.ChaosEngine, err error) {
	obj, err := c.Fake.
...
func (c *FakeChaosEngines) Update(ctx context.Context, chaosEngine *v1alpha1.ChaosEngine) (result *v1alpha1.ChaosEngine, err error) {
	obj, err := c.Fake.
...
func (c *FakeChaosEngines) UpdateStatus(ctx context.Context, chaosEngine *v1alpha1.ChaosEngine) (*v1alpha1.ChaosEngine, error) {
	obj, err := c.Fake.
...
func (c *FakeChaosEngines) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeChaosEngines) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
...
func (c *FakeChaosEngines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ChaosEngine, err error) {
	obj, err := c.Fake.
