...
func (c *FakeChaosExperiments) Create(ctx context.Context, chaosExperiment *v1alpha1.ChaosExperiment) (result *v1alpha1.ChaosExperiment, err error) {
	obj, err := c.Fake.
...
func (c *FakeChaosExperiments) Update(ctx context.Context, chaosExperiment *v1alpha1.ChaosExperiment) (result *v1alpha1.ChaosExperiment, err error) {
	obj, err := c.Fake.
...
func (c *FakeChaosExperiments) UpdateStatus(ctx context.Context, chaosExperiment *v1alpha1.ChaosExperiment) (*v1alpha1.ChaosExperiment, error) {
	obj, err := c.Fake.
...
func (c *FakeChaosExperiments) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeChaosExperiments) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
...
func (c *FakeChaosExperiments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ChaosExperiment, err error) {
	obj, err := c.Fake.
