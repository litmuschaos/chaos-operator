...
func TestCheckChaosAnnotationDeployment(t *testing.T) {
	...
	for name, mock := range tests {
		t.Run(name, func(t *testing.T) {
			...
			_, err := f.litmusClient.LitmuschaosV1alpha1().ChaosEngines(mock.engine.Instance.Namespace).Create(context.Background(), mock.engine.Instance, metav1.CreateOptions{})
			if err != nil {
...
func (f *fixture) SetFakeClient() {
	...
	f.dynamicClient = dynamicfake.NewSimpleDynamicClientWithCustomListKinds(runtime.NewScheme(), gvrToListKind, f.dynamicObjects...)
}
