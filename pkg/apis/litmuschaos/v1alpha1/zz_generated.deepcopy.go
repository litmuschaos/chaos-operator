...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChaosStatusDetails) DeepCopyInto(out *ChaosStatusDetails) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChaosStatusDetails.
func (in *ChaosStatusDetails) DeepCopy() *ChaosStatusDetails {
	if in == nil {
		return nil
	}
	out := new(ChaosStatusDetails)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HistoryDetails) DeepCopyInto(out *HistoryDetails) {
	*out = *in
	if in.ChaosStatus != nil {
		in, out := &in.ChaosStatus, &out.ChaosStatus
		*out = make([]ChaosStatusDetails, len(*in))
		copy(*out, *in)
	}
	return
}
